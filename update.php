...
$sql = "UPDATE `tb_flower` SET `N_title`='".$title."', `N_author`='".$author."', `N_type`='".$type."',`N_content`='".$details."' WHERE `ID`=".$id;
$result = mysqli_query($link,$sql);
if($result){
    echo '<script>alert("修改成功..."),location="edit.php"</script>';
}
else{
    echo '<script>alert("修改失败..."),location="edit.php"</script>';
}
mysqli_close($link);
?>